...
interface IOnChainDataFormState {
  id: string;
  tokenName: string;
  tokenSymbol: string;
  isMinted: boolean;
...
class OnChainDataForm extends React.Component<IOnChainDataFormProps, IOnChainDataFormState> {
  public readonly state: IOnChainDataFormState = {
    id: '',
    tokenName: '',
    tokenSymbol: '',
    isMinted: false,
  ...
  public render(): React.ReactNode {
    ...
    return (
      <Layout location={location} history={history} showSidebar={true}>
        <Container>
          <br />
          <h5 className="text-center">{t('createToken.creator')}</h5>
          <br />
